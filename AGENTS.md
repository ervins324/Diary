...
6. **AI Import**: Backend Google Gemini Vision / `google-genai` SDK is removed in favor of prompt-driven JSON import (compatible with ChatGPT, Claude, Gemini Web, DeepSeek without backend API keys).
