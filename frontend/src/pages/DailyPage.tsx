      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            <p className="text-text-muted text-lg mb-2">No lessons scheduled</p>
            <p className="text-sm text-text-secondary">Take a break or add something new!</p>
          </div>
        ) : (
