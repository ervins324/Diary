    ...
    <div className="flex-1 max-w-3xl mx-auto w-full p-4 md:p-6 overflow-y-auto">
      ...
      <div className="space-y-8">
        ...
        <section className="bg-bg-secondary p-5 rounded-xl border border-border">
          <h2 className="text-lg font-semibold text-text-primary mb-4 border-b border-border-light pb-2">Appearance</h2>
        ...
        {/* Subjects */}
        <section className="bg-bg-secondary p-5 rounded-xl border border-border">
          <h2 className="text-lg font-semibold text-text-primary mb-4 border-b border-border-light pb-2">Manage Subjects</h2>
          ...
          {isLoading ? (
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-12 gap-2 text-xs font-medium text-text-secondary px-2 pb-1 hidden sm:grid">
                ...
                <div className="col-span-2">Cabinet</div>
                  ...
                  {editingId === subject.id ? (
                    <>
                      ...
                      <div className="col-span-1 sm:col-span-4">
                        <input type="text" value={editForm.name || ''} onChange={e => setEditForm({...editForm, name: e.target.value})} className="w-full bg-bg-secondary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent" placeholder="Name" />
                      </div>
                      <div className="col-span-1 sm:col-span-3">
                        <input type="text" value={editForm.short_name || ''} onChange={e => setEditForm({...editForm, short_name: e.target.value})} className="w-full bg-bg-secondary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent" placeholder="Short" />
                      </div>
                      <div className="col-span-1 sm:col-span-2">
                        <input type="text" value={editForm.default_cabinet || ''} onChange={e => setEditForm({...editForm, default_cabinet: e.target.value})} className="w-full bg-bg-secondary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent" placeholder="Cab" />
                      </div>
                    ...
                    <>
                      ...
                      <div className="col-span-1 sm:col-span-3 text-text-secondary truncate"><span className="sm:hidden text-xs mr-2">Short:</span>{subject.short_name}</div>
                      <div className="col-span-1 sm:col-span-2 text-text-secondary truncate"><span className="sm:hidden text-xs mr-2">Cab:</span>{subject.default_cabinet || '-'}</div>
              ...
              {isAdding ? (
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-center bg-accent-light/50 p-2 rounded border border-accent border-dashed text-sm mt-4">
                  ...
                  <div className="col-span-1 sm:col-span-4">
                    <input type="text" value={addForm.name} onChange={e => setAddForm({...addForm, name: e.target.value})} className="w-full bg-bg-secondary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent" placeholder="Subject Name" autoFocus />
                  </div>
                  <div className="col-span-1 sm:col-span-3">
                    <input type="text" value={addForm.short_name} onChange={e => setAddForm({...addForm, short_name: e.target.value})} className="w-full bg-bg-secondary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent" placeholder="Short Name" />
                  </div>
                  <div className="col-span-1 sm:col-span-2">
                    <input type="text" value={addForm.default_cabinet ?? ''} onChange={e => setAddForm({...addForm, default_cabinet: e.target.value})} className="w-full bg-bg-secondary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent" placeholder="Cabinet" />
                  </div>
                  <div className="col-span-1 sm:col-span-2 flex justify-end gap-2">
                    <button onClick={handleAdd} className="text-accent hover:bg-accent/10 p-1 rounded font-medium text-xs px-2">Add</button>
