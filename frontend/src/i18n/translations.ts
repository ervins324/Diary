...
export const translations = {
  en: {
    ...
    export_backup_failed: 'Failed to export backup.',
    ...
    date: 'Date',
    // v1.9.2 — Consultation, Icon Size, Zoom
    consultation_badge: 'Consultation',
    hw_icon_size: 'Homework icon size',
    hw_icon_size_desc: 'Adjust the size of action icons on homework entries',
    hw_icon_size_small: 'Small',
    hw_icon_size_medium: 'Medium',
    hw_icon_size_large: 'Large',
    table_consultation: 'Consultation',
    skip_consultation: 'Skip Consultation',
    skip_consultation_desc: 'Consultations are optional. 1-click mark as skipped',
    skipped_consultation: 'Skipped',
    schedule_editor_consultation_hint: 'Mark lessons as «Consultation» to display a consultation badge. Students can skip them in 1 click in the diary.',
    zoom_reset: 'Reset Zoom (100%)',
    drag_to_pan: 'Drag to pan image',
    subject: 'Subject',

    // v1.9.5 — Homework Page
    homework_title: 'Homework',
    homework_subtitle: 'Manage assignments, deadlines, attachments, and study timer',
    hw_filter_all: 'All',
    hw_filter_pending: 'Pending',
    hw_filter_completed: 'Completed',
    hw_filter_failed: 'Failed',
    hw_search_placeholder: 'Search by subject, task description, or date...',
    hw_all_subjects: 'All Subjects',
    hw_sort_due_asc: 'Due Date (Soonest)',
    hw_sort_due_desc: 'Due Date (Latest)',
    hw_sort_created: 'Recently Added',
    hw_add_new: 'Add Homework',
    hw_edit_title: 'Edit Homework',
    hw_create_title: 'New Homework',
    hw_subject: 'Subject',
    hw_subject_select: 'Select subject...',
    hw_due_date: 'Due Date',
    hw_assigned_date: 'Assigned Date',
    hw_lesson_order: 'Lesson Number',
    hw_lesson_order_optional: 'Lesson # (optional)',
    hw_text: 'Task Description',
    hw_text_placeholder: 'Write homework details, textbook pages, exercise numbers...',
    hw_attachments: 'Attachments',
    hw_add_photo: 'Add Photo',
    hw_add_file: 'Add Document (PDF/PPT)',
    hw_add_link: 'Add Link',
    hw_quick_tomorrow: 'Tomorrow',
    hw_quick_today: 'Today',
    hw_quick_next_week: 'Next Week',
    hw_overdue: 'Overdue',
    hw_due_today: 'Due Today',
    hw_due_tomorrow: 'Due Tomorrow',
    hw_study_time: 'Study Time',
    hw_total_tasks: 'Total Tasks',
    hw_pending_tasks: 'Pending',
    hw_completed_tasks: 'Completed',
    hw_failed_tasks: 'Failed',
    hw_completion_rate: 'Completion Rate',
    hw_delete_confirm: 'Are you sure you want to delete this homework assignment?',
    hw_empty_pending: 'All assignments are completed! Great job.',
    hw_empty_completed: 'No completed tasks yet. Check off items as you finish them.',
    hw_empty_failed: 'No failed homework tasks. Keep it up!',
    hw_empty_all: 'No homework assignments found.',
    hw_empty_filtered: 'No homework matches your filters.',
    hw_go_to_diary: 'View in Diary',
    saving: 'Saving...',
    hw_mark_completed: 'Mark as completed',
    hw_mark_pending: 'Mark as pending',
    hw_timeframe_all: 'All Dates',
    hw_timeframe_today: 'Today',
  ...
  uk: {
    ...
    export_backup_failed: 'Не вдалося експортувати резервну копію.',
    ...
    date: 'Дата',
    // v1.9.2 — Консультація, Розмір іконок, Зум
    consultation_badge: 'Консультація',
    hw_icon_size: 'Розмір іконок Д/З',
    hw_icon_size_desc: 'Налаштуйте розмір іконок дій на домашніх завданнях',
    hw_icon_size_small: 'Малий',
    hw_icon_size_medium: 'Середній',
    hw_icon_size_large: 'Великий',
    table_consultation: 'Консультація',
    skip_consultation: 'Пропустити консультацію',
    skip_consultation_desc: 'Консультація необовʼязкова. 1 клік — позначити пропущеною',
    skipped_consultation: 'Пропущено',
    schedule_editor_consultation_hint: 'Позначте уроки як «Консультація», щоб додати бейдж. У щоденнику їх можна пропустити в 1 клік.',
    zoom_reset: 'Скинути масштаб (100%)',
    drag_to_pan: 'Перетягуйте для перегляду',
    subject: 'Предмет',

    // v1.9.5 — Вкладка Д/З
    homework_title: 'Домашні завдання',
    homework_subtitle: 'Керуйте всіма завданнями, дедлайнами, файлами та таймером навчання',
    hw_filter_all: 'Всі',
    hw_filter_pending: 'В процесі',
    hw_filter_completed: 'Виконано',
    hw_filter_failed: 'Не зроблено',
    hw_search_placeholder: 'Пошук за предметом, описом або датою...',
    hw_all_subjects: 'Всі предмети',
    hw_sort_due_asc: 'Термін (спочатку найближчі)',
    hw_sort_due_desc: 'Термін (спочатку пізніші)',
    hw_sort_created: 'Нещодавно додані',
    hw_add_new: 'Додати Д/З',
    hw_edit_title: 'Редагувати Д/З',
    hw_create_title: 'Нове домашнє завдання',
    hw_subject: 'Предмет',
    hw_subject_select: 'Оберіть предмет...',
    hw_due_date: 'Термін здачі',
    hw_assigned_date: 'Дата завдання',
    hw_lesson_order: 'Номер уроку',
    hw_lesson_order_optional: 'Урок № (необовʼязково)',
    hw_text: 'Опис завдання',
    hw_text_placeholder: 'Напишіть завдання, параграф, номери вправ...',
    hw_attachments: 'Прикріплені матеріали',
    hw_add_photo: 'Додати фото',
    hw_add_file: 'Додати документ (PDF/PPT)',
    hw_add_link: 'Додати посилання',
    hw_quick_tomorrow: 'Завтра',
    hw_quick_today: 'Сьогодні',
    hw_quick_next_week: 'Наступний тиждень',
    hw_overdue: 'Прострочено',
    hw_due_today: 'Здати сьогодні',
    hw_due_tomorrow: 'Здати завтра',
    hw_study_time: 'Час на Д/З',
    hw_total_tasks: 'Всього завдань',
    hw_pending_tasks: 'В процесі',
    hw_completed_tasks: 'Виконано',
    hw_failed_tasks: 'Не зроблено',
    hw_completion_rate: 'Успішність',
    hw_delete_confirm: 'Ви впевнені, що хочете видалити це домашнє завдання?',
    hw_empty_pending: 'Всі завдання виконано! Чудова робота, можна відпочити.',
    hw_empty_completed: 'Ще немає виконаних завдань. Позначайте виконані завдання галочкою.',
    hw_empty_failed: 'Немає провалених завдань. Так тримати!',
    hw_empty_all: 'Домашніх завдань ще не додано.',
    hw_empty_filtered: 'Не знайдено завдань за обраними фільтрами.',
    hw_go_to_diary: 'Переглянути в щоденнику',
    saving: 'Збереження...',
    hw_mark_completed: 'Позначити виконаним',
    hw_mark_pending: 'Повернути в процес',
    hw_timeframe_all: 'Весь час',
    hw_timeframe_today: 'Сьогодні',
